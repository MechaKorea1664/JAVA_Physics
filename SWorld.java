...
public class SWorld extends World
{
    ...
    GreenfootImage bg1 = new GreenfootImage("background.png");
    GreenfootImage bg0 = new GreenfootImage​("BackgroundStart.png");
    GreenfootSound bgm0 = new GreenfootSound("adventuresInAdventureland.mp3"); //Victory by Alexander Nakarada, Link: https://filmmusic.io/song/4924-victory, License: https://filmmusic.io/standard-license
    GreenfootSound bgm1 = new GreenfootSound("to-the-ends-by-kevin-macleod-from-filmmusic-io.mp3"); //To the Ends by Kevin MacLeod, Link: https://incompetech.filmmusic.io/song/4532-to-the-ends, License: https://filmmusic.io/standard-license    
